...
CREATE TABLE `branches` (
  ...
  `add_one` varchar(1000) NOT NULL,
  `add_two` varchar(1000) NOT NULL,
...
INSERT INTO `branches` (`id`, `b_name`, `state`, `district`, `add_one`, `add_two`, `pincode`, `created_at`) VALUES
(1, 'b1', '18', 'Kasaragod', 'c1', 'd1', '123344', '2020-07-20 08:31:22');
...
(1, 'JASPER', '2020-07-17 12:19:39'),
(2, 'CLASSIC', '2020-07-17 12:19:39'),
(9, 'Tamar', '2020-07-17 12:23:09');
